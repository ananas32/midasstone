...
class ModelCatalogProduct extends Model {
    ...
    public function getGalleryPhoto() {
        $sql = "SELECT * FROM `" . DB_PREFIX . "gallery_photo`";
        $query = $this->db->query($sql);
        return $query->rows;
    }

    public function getTotalPhoto() {
        $sql = "SELECT COUNT(*) FROM `" . DB_PREFIX . "gallery_photo`";
        $query = $this->db->query($sql);
	...
	public function getCategoryProduct($product_id){
	    $cat = $this->db->query( 'SELECT `category_id` FROM `' . DB_PREFIX . 'product_to_category` WHERE `product_id` = ' . (int)$product_id );
	    return $cat->rows;
    }
}
