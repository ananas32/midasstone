...
<div class="bottom-menu">
  <div class="row" style="border: 1px solid red; max-width: 1127px; margin: auto;">
          ...
          <ul id="accordion">
            <li>
              ...
              <ul class="menuLvl1" style="" onmouseover="document.getElementById('fon-cat').style.display='block';">
                ...
                <li><a href="<?php echo $children['href']; ?>"  class ="<?php if ($children['children']) echo 'down-menu'; ?>" data-popup="popup-kat<?php echo $key; ?>" ><?php echo $children['name']; ?></a></li>
                <?php /*
                      <li><a href="<?php echo $children['href']; ?>"  <?php if ($children['children']) { ?>
                onmouseover="document.getElementById('popup-kat<?php echo $key; ?>').style.display='block',
                document.getElementById('fon-cat').style.display='block';"<?php } ?> ><?php echo $children['name']; ?></a></li> */ ?>
                <?php } ?>
                <?php }?>
                <?php } ?>
              </ul>
        ...
        <div id="popup-kat<?php echo $key;?>" class="popup-katalog">
          ...
          <div class="popup-katalog-items">
            <div class="popup-katalog-item">
              ...
              <ul class="list-unstyled">
                <li><a href="<?php echo $child2['href']; ?>" class="header-list"><?php echo $child2['name'] ?></a></li>
    ...
    <div class="col-sm-5" style="border: 1px solid skyblue"><?php echo $search; ?></div>
    <div class="col-sm-3 text-right" style=" border: 1px solid black"><?php echo $cart; ?></div>
  </div>
