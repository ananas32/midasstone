    ...
    if (isset($this->request->get['filter_ocfilter'])) {
      ...
      $filter_ocfilter = '';
		...
		if ($category_info) {
            ...
            $tpPage = $this->model_catalog_category->getTotalPathId($category_id);

            switch ($tpPage['level']){
                case 1:
                case 2:
                    //$this->document->addStyle('catalog/view/theme/midasstone/scripts/slick/slick.css');
                    //$this->document->addStyle('catalog/view/theme/midasstone/scripts/slick/slick-theme.css');
                    //$this->document->addStyle('catalog/view/theme/midasstone/scripts/slick/slicknav.min.css');
                    //$this->document->addStyle('catalog/view/theme/midasstone/scripts/ui/jquery-ui.css');
                    //$this->document->addScript('catalog/view/theme/midasstone/scripts/slick/slick.min.js');
                    //$this->document->addScript('catalog/view/theme/midasstone/scripts/slick/jquery.slicknav.min.js');
                    //$this->document->addScript('catalog/view/theme/midasstone/scripts/ui/jquery-ui.js');
                    //$this->document->addScript('catalog/view/theme/midasstone/scripts/formcheck.js');
                    //$this->document->addScript('catalog/view/theme/midasstone/scripts/is.mobile.js');
                    //$this->document->addScript('catalog/view/theme/midasstone/scripts/jquery.maskedinput.min.js');
            ...
            foreach ($results as $category) {
                ...
                $child_id = 0;                foreach($children as $child) {
                    $filter_data = array('filter_category_id' => $child['category_id'], 'filter_sub_category' => true);
                    $children_data[] = array(
                        'name' => $child['name'],
                        'image'=> $child['image']?'/image/'.$child['image']:$this->model_tool_image->resize('placeholder.png', $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height')),
                ...
                $data['categories'][] = array(
                    ...
                    'name'        => $category['name'],
                    'image'       => $category['image']?'/image/'.$category['image']:$this->model_tool_image->resize('placeholder.png', $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height')),
            ...
            if($tpPage['level'] == 2) {
                ...
                foreach ($data['categories'] as $k => $cat) {
                    if($k < 3){
                        ...
                        $data['productCategory'][] = array(
                            'pName'   => $cat['name'],
                            'products' => $this->getProductCategor($filter_data_new,$url)
                        );
                    }
                }
            }
      ...
      // OCFilter End
			...
			$data['header'] = $this->load->controller('common/header');
 			$templ = $tpPage['level']?$tpPage['level']:'';
            //($this->load->view('product/category'.$templ, $data));
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/category'.$templ.'.tpl', $data));
