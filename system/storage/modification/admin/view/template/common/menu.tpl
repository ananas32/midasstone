  ...
  <li><a class="parent"><i class="fa fa-share-alt fa-fw"></i> <span><?php echo $text_marketing; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $contact; ?>"><?php echo $text_contact; ?></a></li>
				...
				<li id="blog"><a class="parent"><i class="fa fa-pencil-square-o fa-fw"></i> <span>Статьи</span></a>
					<ul>
						<li><a href="<?php echo $blog_article; ?>">Статьи</a></li>
						<li><a href="<?php echo $blog_setting; ?>">Настройки</a></li>
