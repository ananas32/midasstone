    ...
    <div class="ordering">
      ...
      <div class="ordering-form">
        <div class="fio-form">
          ...
          <input placeholder="Iм'я*" name="name"  type="text" size="40" pattern="\D [^0-9]" required>
        </div>
        <div class="phone-form">
          <div class="icon-phone"></div>
          <input placeholder="Телефон*" name="tel" type="tel" size="40" id="tel" required>
        </div>
        <div class="mail-form">
          <div class="icon-mail"></div>
          <input placeholder="Електронна пошта*" type="email" name="email" id="user_mail" size="40">
        </div>
    ...
    <div class="receiving">
      ...
      <div class="receiving-form">
        <div class="fio-form">
          ...
          <input placeholder="Адреса" type="text" size="40">
        </div>
        <div class="dostavka-adr">
          <div class="radioblock">
            <div class="radio">Доставка за вказаною адресою</div>
            <div class="radio">Самостійне вивезення</div>
            <div class="clear"></div>
        ...
        <div class="coment-f">
          <textarea name="comment" cols="30" rows="3" placeholder="Коментар"></textarea>
        </div>
      </div>
    </div>
    <div class="payment">
      ...
      <div class="payment-oplata">
        <div class="radioblock">
          <div class="radio"><p>Розрахунок готівкою чи карткою при отриманні замовлення</p></div>
          <div class="radio"><p>Сплатити банківською картою на сайті</p></div>
          <div class="clear"></div>
      ...
      <div class="confirm">
        <div class="summa-tovaru">
          ...
          <div class="product-price">3280.00 <span>&nbspгрн/м3</span></div>
        </div>
        <button type="submit" class="btnsubmit">Оформити замовлення</button>
        <p>* - обов’язкові поля.</p>

        <p>Підтверджуючи замовлення, ви приймаєте умови <a href="#"> угоди користувача</a></p>
      </div>
    </div>
...
<script>
  $(function(){
      $('.summa-tovaru .btnsubmit').click(function(){
...
<script type="text/javascript"><!--
    $.ajax({
        ...
        success: function(html) {
            ...
            $('.form-zakaz .ordering-form').html(html);
